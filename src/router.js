...
const routes = [
  ...
  { path: "/favorites", name: "favorites", component: Favorites, meta: { title: "Saved Clippings · 收藏剪報" } },
  { path: "/mistakes", name: "mistakes", component: Mistakes, meta: { title: "Mistake Journal · 錯題簿" } },
];
